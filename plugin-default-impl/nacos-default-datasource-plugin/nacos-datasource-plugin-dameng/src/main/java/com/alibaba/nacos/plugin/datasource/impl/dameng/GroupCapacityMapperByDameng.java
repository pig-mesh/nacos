...
/**
 * The Dameng implementation of {@link GroupCapacityMapper}.
 * Note: the usage column is referenced without quotes so that it matches the (default upper-cased)
 * column name created by dm-schema.sql under Dameng's case-sensitive mode.
 *
 * @author KiteSoar
 */
public class GroupCapacityMapperByDameng extends AbstractMapperByDameng
