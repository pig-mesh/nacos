...
public class HistoryConfigInfoMapperByDameng extends AbstractMapperByDameng
    implements HistoryConfigInfoMapper {

    @Override
    public MapperResult removeConfigHistory(MapperContext context) {
        String sql = "DELETE FROM his_config_info WHERE ROWID IN ("
            + "SELECT ROWID FROM his_config_info WHERE gmt_modified < ? LIMIT ?)";
