...
public class ConfigTagsRelationMapperByDameng extends AbstractMapperByDameng
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        final String sql =
            "SELECT c.id,c.data_id,c.group_id,c.tenant_id,c.app_name,c.content,c.md5,c.type,c.encrypted_data_key,c.c_desc,"
                + "LISTAGG(DISTINCT d.tag_name, ',') WITHIN GROUP (ORDER BY d.tag_name) as config_tags "
                + "FROM ("
