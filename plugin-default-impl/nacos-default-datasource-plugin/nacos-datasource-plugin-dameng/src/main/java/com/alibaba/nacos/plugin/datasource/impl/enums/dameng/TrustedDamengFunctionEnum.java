...
public enum TrustedDamengFunctionEnum {
    ...
    /**
     * NOW(). Dameng does not support the MySQL NOW() function in its default mode, so it is mapped
     * to SYSDATE which is supported in Dameng's Oracle-compatible dialect.
     */
    NOW("NOW()", "SYSDATE");
