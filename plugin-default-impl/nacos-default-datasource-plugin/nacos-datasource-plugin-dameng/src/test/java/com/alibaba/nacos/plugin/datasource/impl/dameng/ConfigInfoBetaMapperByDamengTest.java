...
class ConfigInfoBetaMapperByDamengTest {
    ...
    private ConfigInfoBetaMapperByDameng configInfoBetaMapperByDameng;

    @BeforeEach
    void setUp() throws Exception {
        configInfoBetaMapperByDameng = new ConfigInfoBetaMapperByDameng();
    ...
    void testUpdateConfigInfo4BetaCas() {
        ...
        MapperResult mapperResult = configInfoBetaMapperByDameng.updateConfigInfo4BetaCas(context);
    ...
    void testFindAllConfigInfoBetaForDumpAllFetchRows() {
        MapperResult result =
            configInfoBetaMapperByDameng.findAllConfigInfoBetaForDumpAllFetchRows(context);
    ...
    void testGetTableName() {
        String tableName = configInfoBetaMapperByDameng.getTableName();
        assertEquals(TableConstant.CONFIG_INFO_BETA, tableName);
    }

    @Test
    void testGetDataSource() {
        String dataSource = configInfoBetaMapperByDameng.getDataSource();
