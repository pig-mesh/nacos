...
class ConfigInfoTagMapperByDamengTest {
    ...
    private ConfigInfoTagMapperByDameng configInfoTagMapperByDameng;

    @BeforeEach
    void setUp() throws Exception {
        configInfoTagMapperByDameng = new ConfigInfoTagMapperByDameng();
    ...
    void testUpdateConfigInfo4TagCas() {
        ...
        MapperResult mapperResult = configInfoTagMapperByDameng.updateConfigInfo4TagCas(context);
    ...
    void testFindAllConfigInfoTagForDumpAllFetchRows() {
        MapperResult mapperResult =
            configInfoTagMapperByDameng.findAllConfigInfoTagForDumpAllFetchRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testGetTableName() {
        String tableName = configInfoTagMapperByDameng.getTableName();
        assertEquals(TableConstant.CONFIG_INFO_TAG, tableName);
    }

    @Test
    void testGetDataSource() {
        String dataSource = configInfoTagMapperByDameng.getDataSource();
