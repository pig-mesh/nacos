...
class HistoryConfigInfoMapperByDamengTest {
    ...
    private HistoryConfigInfoMapperByDameng historyConfigInfoMapperByDameng;

    @BeforeEach
    void setUp() throws Exception {
        historyConfigInfoMapperByDameng = new HistoryConfigInfoMapperByDameng();
    ...
    void testRemoveConfigHistory() {
        MapperResult mapperResult = historyConfigInfoMapperByDameng.removeConfigHistory(context);
        assertEquals("DELETE FROM his_config_info WHERE ROWID IN (SELECT ROWID FROM his_config_info WHERE gmt_modified < ? LIMIT ?)",
            mapperResult.getSql());
    ...
    void testFindConfigHistoryCountByTime() {
        MapperResult mapperResult =
            historyConfigInfoMapperByDameng.findConfigHistoryCountByTime(context);
    ...
    void testFindDeletedConfig() {
        MapperResult mapperResult = historyConfigInfoMapperByDameng.findDeletedConfig(context);
        assertEquals(
    ...
    void testFindConfigHistoryFetchRows() {
        ...
        context.putWhereParameter(FieldConstant.DATA_ID, dataId);
        MapperResult mapperResult =
            historyConfigInfoMapperByDameng.findConfigHistoryFetchRows(context);
    ...
    void testDetailPreviousConfigHistory() {
        ...
        MapperResult mapperResult =
            historyConfigInfoMapperByDameng.detailPreviousConfigHistory(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testGetTableName() {
        String tableName = historyConfigInfoMapperByDameng.getTableName();
        assertEquals(TableConstant.HIS_CONFIG_INFO, tableName);
    }

    @Test
    void testGetDataSource() {
        String dataSource = historyConfigInfoMapperByDameng.getDataSource();
