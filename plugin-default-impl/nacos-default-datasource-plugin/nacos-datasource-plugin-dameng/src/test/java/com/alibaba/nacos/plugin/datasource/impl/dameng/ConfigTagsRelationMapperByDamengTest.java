...
class ConfigTagsRelationMapperByDamengTest {
    ...
    private ConfigTagsRelationMapperByDameng configTagsRelationMapperByDameng;

    @BeforeEach
    void setUp() throws Exception {
        configTagsRelationMapperByDameng = new ConfigTagsRelationMapperByDameng();
    ...
    void testFindConfigInfoLike4PageCountRows() {
        MapperResult mapperResult =
            configTagsRelationMapperByDameng.findConfigInfoLike4PageCountRows(context);
    ...
    void testFindConfigInfo4PageCountRows() {
        MapperResult mapperResult =
            configTagsRelationMapperByDameng.findConfigInfo4PageCountRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindConfigInfo4PageFetchRows() {
        ...
        MapperResult mapperResult =
            configTagsRelationMapperByDameng.findConfigInfo4PageFetchRows(context);
        ...
        assertEquals(true,
            sql.contains("LISTAGG(DISTINCT d.tag_name, ',') WITHIN GROUP (ORDER BY d.tag_name) as config_tags"));
    ...
    void tsetFindConfigInfoLike4PageFetchRows() {
        ...
        context.putWhereParameter(FieldConstant.CONTENT, "Content1");
        MapperResult mapperResult =
            configTagsRelationMapperByDameng.findConfigInfoLike4PageFetchRows(context);
        String sql = mapperResult.getSql();
    ...
    void testGetTableName() {
        String tableName = configTagsRelationMapperByDameng.getTableName();
        assertEquals(TableConstant.CONFIG_TAGS_RELATION, tableName);
    }

    @Test
    void testGetDataSource() {
        String dataSource = configTagsRelationMapperByDameng.getDataSource();
