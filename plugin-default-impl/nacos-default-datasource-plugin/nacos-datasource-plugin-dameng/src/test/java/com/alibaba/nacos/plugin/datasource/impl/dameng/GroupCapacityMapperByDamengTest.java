...
class GroupCapacityMapperByDamengTest {
    ...
    private GroupCapacityMapperByDameng groupCapacityMapperByDameng;

    @BeforeEach
    void setUp() throws Exception {
        groupCapacityMapperByDameng = new GroupCapacityMapperByDameng();
    ...
    void testGetTableName() {
        String tableName = groupCapacityMapperByDameng.getTableName();
        assertEquals(TableConstant.GROUP_CAPACITY, tableName);
    }

    @Test
    void testGetDataSource() {
        String dataSource = groupCapacityMapperByDameng.getDataSource();
    ...
    void testInsertIntoSelect() {
        ...
        MapperResult mapperResult = groupCapacityMapperByDameng.insertIntoSelect(context);
    ...
    void testInsertIntoSelectByWhere() {
        ...
        MapperResult mapperResult = groupCapacityMapperByDameng.insertIntoSelectByWhere(context);
        assertEquals(mapperResult.getSql(),
            "INSERT INTO group_capacity (group_id, quota, usage, max_size, max_aggr_count, max_aggr_size, gmt_create,"
    ...
    void testIncrementUsageByWhereQuotaEqualZero() {
        ...
        MapperResult mapperResult =
            groupCapacityMapperByDameng.incrementUsageByWhereQuotaEqualZero(context);
        assertEquals(
    ...
    void testIncrementUsageByWhereQuotaNotEqualZero() {
        ...
        MapperResult mapperResult =
            groupCapacityMapperByDameng.incrementUsageByWhereQuotaNotEqualZero(context);
        assertEquals(
    ...
    void testIncrementUsageByWhere() {
        MapperResult mapperResult = groupCapacityMapperByDameng.incrementUsageByWhere(context);
        assertEquals(
    ...
    void testDecrementUsageByWhere() {
        MapperResult mapperResult = groupCapacityMapperByDameng.decrementUsageByWhere(context);
        assertEquals(
    ...
    void testUpdateUsage() {
        MapperResult mapperResult = groupCapacityMapperByDameng.updateUsage(context);
        assertEquals(
    ...
    void testUpdateUsageByWhere() {
        MapperResult mapperResult = groupCapacityMapperByDameng.updateUsageByWhere(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testSelectGroupInfoBySize() {
        ...
        MapperResult mapperResult = groupCapacityMapperByDameng.selectGroupInfoBySize(context);
