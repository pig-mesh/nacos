...
class ConfigInfoMapperByDamengTest {
    ...
    private ConfigInfoMapperByDameng configInfoMapperByDameng;

    @BeforeEach
    void setUp() throws Exception {
        configInfoMapperByDameng = new ConfigInfoMapperByDameng();
    ...
    void testFindConfigMaxId() {
        MapperResult mapperResult = configInfoMapperByDameng.findConfigMaxId(null);
        assertEquals("SELECT MAX(id) FROM config_info", mapperResult.getSql());
    }

    @Test
    void testFindAllDataIdAndGroup() {
        MapperResult mapperResult = configInfoMapperByDameng.findAllDataIdAndGroup(null);
    ...
    void testFindConfigInfoByAppCountRows() {
        MapperResult mapperResult = configInfoMapperByDameng.findConfigInfoByAppCountRows(context);
    ...
    void testFindConfigInfoByAppFetchRows() {
        MapperResult mapperResult = configInfoMapperByDameng.findConfigInfoByAppFetchRows(context);
    ...
    void testConfigInfoLikeTenantCount() {
        MapperResult mapperResult = configInfoMapperByDameng.configInfoLikeTenantCount(context);
    ...
    void testGetTenantIdList() {
        MapperResult mapperResult = configInfoMapperByDameng.getTenantIdList(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testGetGroupIdList() {
        MapperResult mapperResult = configInfoMapperByDameng.getGroupIdList(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindAllConfigKey() {
        MapperResult mapperResult = configInfoMapperByDameng.findAllConfigKey(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindAllConfigInfoBaseFetchRows() {
        MapperResult mapperResult = configInfoMapperByDameng.findAllConfigInfoBaseFetchRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindAllConfigInfoFragment() {
        ...
        MapperResult mapperResult = configInfoMapperByDameng.findAllConfigInfoFragment(context);
        assertEquals(
        ...
        MapperResult mapperResult2 = configInfoMapperByDameng.findAllConfigInfoFragment(context);
        assertEquals(
    ...
    void testFindChangeConfig() {
        MapperResult mapperResult = configInfoMapperByDameng.findChangeConfig(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindChangeConfigCountRows() {
        ...
        MapperResult mapperResult = configInfoMapperByDameng.findChangeConfigCountRows(context);
        assertEquals(
    ...
    void testFindChangeConfigFetchRows() {
        ...
        context.putWhereParameter(FieldConstant.LAST_MAX_ID, lastMaxId);
        MapperResult mapperResult = configInfoMapperByDameng.findChangeConfigFetchRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testListGroupKeyMd5ByPageFetchRows() {
        MapperResult mapperResult = configInfoMapperByDameng.listGroupKeyMd5ByPageFetchRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindAllConfigInfo4Export() {
        MapperResult mapperResult = configInfoMapperByDameng.findAllConfigInfo4Export(context);
        assertEquals(mapperResult.getSql(),
        ...
        mapperResult = configInfoMapperByDameng.findAllConfigInfo4Export(context);
        assertEquals(mapperResult.getSql(),
            "SELECT id,data_id,group_id,tenant_id,app_name,content,type,md5,gmt_create,gmt_modified,src_user,"
    ...
    void testFindConfigInfoBaseLikeCountRows() {
        MapperResult mapperResult =
            configInfoMapperByDameng.findConfigInfoBaseLikeCountRows(context);
    ...
    void testFindConfigInfoBaseLikeFetchRows() {
        MapperResult mapperResult =
            configInfoMapperByDameng.findConfigInfoBaseLikeFetchRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindConfigInfo4PageCountRows() {
        MapperResult mapperResult = configInfoMapperByDameng.findConfigInfo4PageCountRows(context);
    ...
    void testFindConfigInfo4PageFetchRows() {
        MapperResult mapperResult = configInfoMapperByDameng.findConfigInfo4PageFetchRows(context);
        ...
        String expectedSql =
            "SELECT a.id,a.data_id,a.group_id,a.tenant_id,a.app_name,a.content,a.md5,a.type,a.encrypted_data_key,a.c_desc,"
                + "LISTAGG(b.tag_name, ',') WITHIN GROUP (ORDER BY b.tag_name) as config_tags "
    ...
    void testFindConfigInfoBaseByGroupFetchRows() {
        ...
        MapperResult mapperResult =
            configInfoMapperByDameng.findConfigInfoBaseByGroupFetchRows(context);
        String expectedSql =
    ...
    void testFindConfigInfoLike4PageCountRows() {
        MapperResult mapperResult =
            configInfoMapperByDameng.findConfigInfoLike4PageCountRows(context);
        assertEquals("SELECT count(*) FROM config_info WHERE tenant_id LIKE ?  AND app_name = ? ",
            mapperResult.getSql());
        assertArrayEquals(new Object[] {tenantId, appName}, mapperResult.getParamList().toArray());
    }
    ...
    void testFindConfigInfoLike4PageFetchRows() {
        MapperResult mapperResult =
            configInfoMapperByDameng.findConfigInfoLike4PageFetchRows(context);
        // 验证新的优化后的 SQL 结构：先 LIMIT 再 JOIN
        String expectedInnerSql =
        ...
        String expectedSql =
            "SELECT a.id,a.data_id,a.group_id,a.tenant_id,a.app_name,a.content,a.md5,a.encrypted_data_key,a.type,a.c_desc"
                + ",a.gmt_modified,LISTAGG(b.tag_name, ',') WITHIN GROUP (ORDER BY b.tag_name) as config_tags "
                + "FROM (" + expectedInnerSql + ") a "
                + "LEFT JOIN config_tags_relation b ON a.id=b.id "
    ...
    void testFindAllConfigInfoFetchRows() {
        MapperResult mapperResult = configInfoMapperByDameng.findAllConfigInfoFetchRows(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testFindConfigInfosByIds() {
        MapperResult mapperResult = configInfoMapperByDameng.findConfigInfosByIds(context);
        assertEquals(
    ...
    void testRemoveConfigInfoByIdsAtomic() {
        MapperResult mapperResult = configInfoMapperByDameng.removeConfigInfoByIdsAtomic(context);
    ...
    void testGetTableName() {
        String sql = configInfoMapperByDameng.getTableName();
        assertEquals(TableConstant.CONFIG_INFO, sql);
    }

    @Test
    void testGetDataSource() {
        String sql = configInfoMapperByDameng.getDataSource();
        assertEquals(DatabaseTypeConstant.DM, sql);
    }
    ...
    void testUpdateConfigInfoAtomicCas() {
        ...
        MapperResult mapperResult = configInfoMapperByDameng.updateConfigInfoAtomicCas(context);
        assertEquals(mapperResult.getSql(),
            "UPDATE config_info SET "
                + "content=?, md5=?, src_ip=?, src_user=?, gmt_modified=SYSDATE,"
    ...
    void testFindConfigInfo4PageFetchRowsWithDescAndTags() {
        ConfigInfoMapperByDameng configInfoMapperByDameng = new ConfigInfoMapperByDameng();
        ...
        assertEquals(true, sql.contains("LISTAGG(b.tag_name, ',') WITHIN GROUP (ORDER BY b.tag_name) as config_tags"));
