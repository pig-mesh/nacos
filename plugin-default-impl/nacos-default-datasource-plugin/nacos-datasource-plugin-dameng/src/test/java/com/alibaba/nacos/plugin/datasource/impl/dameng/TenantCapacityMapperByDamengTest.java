...
class TenantCapacityMapperByDamengTest {

    String tenantId = "tenantId";

    MapperContext context;

    private TenantCapacityMapperByDameng tenantCapacityMapperByDameng;
    ...
    void setUp() throws Exception {
        tenantCapacityMapperByDameng = new TenantCapacityMapperByDameng();
    ...
    void testGetTableName() {
        String tableName = tenantCapacityMapperByDameng.getTableName();
        assertEquals(TableConstant.TENANT_CAPACITY, tableName);
    }

    @Test
    void testGetDataSource() {
        String dataSource = tenantCapacityMapperByDameng.getDataSource();
    ...
    void testIncrementUsageWithDefaultQuotaLimit() {
        MapperResult mapperResult =
            tenantCapacityMapperByDameng.incrementUsageWithDefaultQuotaLimit(context);
    ...
    void testIncrementUsageWithQuotaLimit() {
        MapperResult mapperResult =
            tenantCapacityMapperByDameng.incrementUsageWithQuotaLimit(context);
        assertEquals(mapperResult.getSql(),
            "UPDATE tenant_capacity SET usage = usage + 1, gmt_modified = ? WHERE tenant_id = ? AND usage < "
                + "quota AND quota != 0");
    ...
    void testIncrementUsage() {
        MapperResult mapperResult = tenantCapacityMapperByDameng.incrementUsage(context);
        assertEquals(
    ...
    void testDecrementUsage() {
        MapperResult mapperResult = tenantCapacityMapperByDameng.decrementUsage(context);
        assertEquals(
    ...
    void testCorrectUsage() {
        MapperResult mapperResult = tenantCapacityMapperByDameng.correctUsage(context);
        assertEquals(mapperResult.getSql(),
    ...
    void testGetCapacityList4CorrectUsage() {
        ...
        MapperResult mapperResult =
            tenantCapacityMapperByDameng.getCapacityList4CorrectUsage(context);
    ...
    void testInsertTenantCapacity() {
        ...
        MapperResult mapperResult = tenantCapacityMapperByDameng.insertTenantCapacity(context);
        assertEquals(mapperResult.getSql(),
